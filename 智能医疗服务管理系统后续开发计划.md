...
medical-web/src/
├── api/reception.js
├── api/patient.js          # 从 admin.js 拆出患者专用
├── views/reception/*.vue     # 5 个业务页
├── views/patient/PatientMedicalRecordList.vue
├── views/patient/PatientPrescriptionList.vue
├── views/user/ChangePassword.vue
├── views/patient/AiConsultChat.vue           # 阶段 E
├── components/ai/*.vue                     # 阶段 E
├── api/ai-consult.js                         # 阶段 E
└── utils/route-permissions.js
```
